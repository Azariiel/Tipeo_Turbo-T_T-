...
public class avanzado extends JDialog implements ActionListener {
    ...
    private Integer segundosRestantes = 210;

  public avanzado(pantalla parent, boolean modal) {
    super(parent, modal);
    ...
    tiempo = new Timer(1000, new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
          ...
          if (segundosRestantes == 0) {
            tiempo.stop();
            JOptionPane.showMessageDialog(avanzado.this, "¡Tiempo agotado!");
 ...
 public void actionPerformed(ActionEvent e) {
  ...
  public static String palabras() {
    ...
    String[] palabras = {"Desarrolladores", "Multidisciplinario", "Inconformidad", "Burocráticamente", "Ininterrumpido",
    "Inconmensurable", "Perpendicularidad", "Electrodoméstico", "Internacionalización", "Recompensador", "Incongruente",
    "Desobediencia", "Interconexión", "Imprevisibilidad", "Sobrealimentación", "Solidaridad", "Politécnico", "Profesionalismo",
    "Reconocimiento", "Desoxirribonucleico", "Alcalinotérreos", "Checoslovaquia", "Macroeconómicos"};
  ...
  private void verificarPalabra() {
    ...
    if (respuesta.equals(label1.getText())) {
      palabrasCorrectas++;
      if (palabrasCorrectas >= 20) {
        JOptionPane.showMessageDialog(this, "Has ingresado 20 palabras correctamente. El programa ha terminado. Tus errores fueron: "+palabrasIncorrectas);
        palabrasMostradas.clear();
        setVisible(false);
      } else {
      ...
      texto.setText(""); // Limpiar el campo de texto
      if(palabrasIncorrectas>=10){
        JOptionPane.showMessageDialog(this, "Hiciste 10 errores. Vuelve a intentarlo.");
        palabrasMostradas.clear();
        setVisible(false);
      }
    }
