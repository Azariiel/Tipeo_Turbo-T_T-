...
public class principiante extends JDialog implements ActionListener {
    ...
    private Integer segundosRestantes = 90;


    public principiante(pantalla parent, boolean modal) {
      ...
      // Centrar la ventana secundaria en relación a la ventana principal
    ...
    tiempo = new Timer(1000, new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
          ...
          if (segundosRestantes == 0) {
            tiempo.stop();
            JOptionPane.showMessageDialog(principiante.this, "¡Tiempo agotado!");
 ...
 public void actionPerformed(ActionEvent e) {
  ...
  public static String palabras() {
    ...
    String[] palabras = {"Hola", "Sol", "Luna", "Caso", "Gato", "Perro", "Flor", "Amigo", "Lago", "Libro", "Hernan", "Ramo", "Silla", "Mesa", "Plato",
    "Ave", "Rato", "Día", "Huevo", "Dedo"};
  ...
  private void verificarPalabra() {
    ...
    if (respuesta.equals(label1.getText())) {
      palabrasCorrectas++;
      if (palabrasCorrectas >= 10) {
        JOptionPane.showMessageDialog(this, "Has ingresado 10 palabras correctamente. El programa ha terminado. Tus errores fueron: "+palabrasIncorrectas);
        palabrasMostradas.clear();
        setVisible(false);
      }else {
      ...
      texto.setText(""); // Limpiar el campo de texto
      if(palabrasIncorrectas>=40){
        JOptionPane.showMessageDialog(this, "Hiciste 40 errores. Vuelve a intentarlo.");
        palabrasMostradas.clear();
        setVisible(false);
      }
    }
